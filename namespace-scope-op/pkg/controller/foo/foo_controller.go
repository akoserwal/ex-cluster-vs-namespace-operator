...
import (
	...
	cachev1alpha1 "github.com/akoserwal/ex-cluster-vs-namespace-operatorr/namespace-scope-op/pkg/apis/cache/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cachev1alpha1.Foo{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *cachev1alpha1.Foo) *corev1.Pod {
